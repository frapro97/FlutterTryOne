    ...
    return Container( //piu sofisticato di center, lo uso con il suo construttore nominale
      ...
      child: Column( //altro widget per strutturare il layout
        children: <Widget>[ //lista di widget
          Text("Testo breve", textDirection: TextDirection.ltr,),
          Text("Testo abbastanza lungo", textDirection: TextDirection.ltr,),
          Text("Testo meno breve", textDirection: TextDirection.ltr,)
        ]
      )
    );
  } 
