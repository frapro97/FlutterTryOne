...
class MyApp extends StatelessWidget{//StatelessWidget è un interfaccia
  ...
  final String myText = "Hello World!"; //metto final perché cosi il valore non potrà piu essere cambiato (widget stateles)
  ...
  Widget build(BuildContext context) { //metodo astratto dell'interfaccia (genera il contenuto) viene chiamato in automatico
    ...
    return Container( //piu sofisticato di center, lo uso con il suo construttore nominale
      ...
      child: Column( //altro widget per strutturare il layout
        crossAxisAlignment: CrossAxisAlignment.stretch, //forza i figli ad espandersi lungo l'asse secondaria, nel caso column asse x (perche column si sviluppa in verticale)
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(//ci metto dentro dei parametri nominali
      title: 'Flutter Demo',
      theme: ThemeData( 
